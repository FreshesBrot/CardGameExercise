...
template<typename ProtocolType, typename Instance>
class Subscriber {
public:

	typedef std::shared_ptr<ProtocolProvider<ProtocolType>> QueuePtr;
...
private:
	...
	virtual void listenHandlerHead() {
		std::cout << "Listening now..." << std::endl;
